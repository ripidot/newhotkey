...
[Figma 設計図](https://www.figma.com/design/1mnWRrs2KoO3GsV7ktOTae/keylogvisualization?node-id=0-1&p=f&t=1hmgQ5UvnzGZv1Qs-0)
...
## 開発全体で悩んだ点
- TypeScriptでよく使われる関数式
- 状態(state)や副作用(Effect)、コンポーネント引数(Props)の概念
- apiサーバやDBサーバが再起動中のフロントの表示
- Dockerの環境設定
- SQLインジェクション対策とapi設計
- ホットリロード機能のための設定
- I/OスパイクによるDBの消失と復元、原因の特定
